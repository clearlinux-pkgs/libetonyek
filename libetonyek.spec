...
Source0  : https://dev-www.libreoffice.org/src/libetonyek-0.1.10.tar.xz
...
%prep
%setup -q -n libetonyek-0.1.10
cd %{_builddir}/libetonyek-0.1.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622847978
...
cp %{_builddir}/libetonyek-0.1.10/COPYING %{buildroot}/usr/share/package-licenses/libetonyek/9744cedce099f727b327cd9913a1fdc58a7f5599
%make_install
